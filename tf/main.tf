...
output "ws_1_public_ip" {
  value = aws_instance.ansible-webserver[0].public_ip
}

output "ws_2_public_ip" {
  value = aws_instance.ansible-webserver[1].public_ip
}

output "lb_public_ip" {
  value = aws_instance.ansible-loadbalancer.public_ip
}
